...
| Runtime, API, worker, web app                        | **Not started.** Planned in [`docs/UPGRADE_PLAN.md`](docs/UPGRADE_PLAN.md), phases P1–P5                                                                                                                                                                      |
...
Planned packages and apps (runtime, API, worker, web, SDK, CLI,
