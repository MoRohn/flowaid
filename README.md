...
| `@flowaid/workflow-runtime`                          | **Built.** Event-sourced scheduler for all ten node kinds (retries on durable timers, joins and races, loops, foreach, subflows, waits, human tasks), orchestrator with fenced appends, leases and crash recovery, recorded replay, write-time redaction, `runLocally()`, BullMQ and Redis drivers. 75 tests incl. replay-determinism properties |
| `@flowaid/shared`, `@flowaid/env`, `@flowaid/config` | **Built.** Primitives, environment schema and tooling presets. 136 tests                                                                                                                                                                                                                                                                         |
| API, worker, web app                                 | **Not started.** Planned in [`docs/UPGRADE_PLAN.md`](docs/UPGRADE_PLAN.md), phases P1–P5                                                                                                                                                                                                                                                         |
...
Planned packages and apps (API, worker, web, SDK, CLI,
