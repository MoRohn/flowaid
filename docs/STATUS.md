...
- **Phase 1:** P1-01 (workflow compiler), P1-03 (node SDK), P1-04 (providers), P1-05 (credentials) and P1-06 (observability) done. P1-02 and P1-07 not started.
...
None open from the 2026-09-23 list. Next on the critical path: P2-01 (runtime), with the rest of Phase 1; the rest of Phase 1 (database, UI widgets) runs alongside, as do tracks J and L where they are buildable.
